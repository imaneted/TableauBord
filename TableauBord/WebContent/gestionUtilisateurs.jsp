                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                    <li><a href="javascript:;">  Menu principal</a>
                                    </li>
                                ...
                                <div class="x_content">
                                    ...
                                    <div id="wizard" class="form_wizard wizard_horizontal">
                                        ...
                                        <div class="actionBar">
                                          ...
                                          <a href="#" class="btn btn-success buttonDisabled">Next</a>
                                          <a href="#" class="btn btn-primary">Previous</a></div>
                                    </div>
